...
한국 남성과 일본 여성을 이어주는 소개팅 서비스 **"앤(縁)"** 의 안드로이드 앱 프론트엔드입니다.
...
## 🧑‍💻 안드로이드 개발자
| <img width="100" src="https://github.com/fkal829.png"> | <img width="100" src="https://github.com/mark77234.png"> |  
|:------------------------------------------------------:|:-----------------------------------------------------:|
|           [이예람](https://github.com/fkal829)            |          [이병찬](https://github.com/mark77234)          | 
